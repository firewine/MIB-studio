...
def build_launcher(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "command_sequence": [
            ...
            command_row("run_real_adapter_cuda_training_handoff", training_command, note="Invoke the existing guarded CUDA training handoff only after packet verification passes."),
        ],
        "guardrails": [
